...
router.patch('/suspend-agent/:id',checkAuth(Role.ADMIN),agentController.suspendAgent)
router.post('/cash-in-agent/:id',checkAuth(Role.ADMIN),agentController.CashInAgent)
